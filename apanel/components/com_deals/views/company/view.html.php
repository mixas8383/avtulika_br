 ...
 * @since		1.5
 */
class DealsViewCompany extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_DEALS_MANAGER_COMPANY_NEW') : JText::_('COM_DEALS_MANAGER_COMPANY_EDIT'), 'deals.png');
