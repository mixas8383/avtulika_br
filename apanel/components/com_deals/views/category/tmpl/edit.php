...
<script type="text/javascript">
	...
	{
		if (task == 'category.cancel' || document.formvalidator.isValid(document.id('deal-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option='.JCOMPONENT.'&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="deal-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo empty($this->item->id) ? JText::_('COM_DEALS_NEW_CATEGORY') : JText::sprintf('COM_DEALS_DEAL_DETAILS', $this->item->id); ?></legend>
