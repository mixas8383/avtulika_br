		...
		<?php echo  JHtml::_('sliders.start', 'contact-slider'); ?>
			...
			<fieldset class="panelform">
				...
				<ul class="adminformlist">
					...
					<li><?php echo $this->form->getLabel('map_url'); ?>
					<?php echo $this->form->getInput('map_url'); ?></li>

					<li><?php echo $this->form->getLabel('map_width'); ?>
					<?php echo $this->form->getInput('map_width'); ?></li>

					<li><?php echo $this->form->getLabel('map_height'); ?>
					<?php echo $this->form->getInput('map_height'); ?></li>
