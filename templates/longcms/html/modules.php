...
function modChrome_cont($module, &$params, &$attribs)
{
	if (!empty ($module->content)) { ?>
    <div class="module_block">
        <?php if ($module->showtitle) { ?>
            <div class="module_title<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
                <?php echo $module->title; ?>
            </div>
        <?php }; ?> 
        <div class="module_body<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
...
function modChrome_foot($module, &$params, &$attribs)
{
	if (!empty ($module->content)) { ?>
    <div class="footer_block">
        <?php if ($module->showtitle) { ?>
            <div class="footinfo_title<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
                <?php echo $module->title; ?>
            </div>
        <?php }; ?> 
        <div class="footinfo_body<?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
            <?php echo $module->content; ?>
        </div>
    </div>
	<?php 
