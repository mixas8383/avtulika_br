...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>" xmlns:og="http://ogp.me/ns#" xmlns:fb="http://www.facebook.com/2008/fbml">
    <head>
        ...
        <link rel="stylesheet" href="templates/<?php echo $this->template ?>/css/style.css<?php echo JDEBUG?'?'.$rand:'?v=16'; ?>"/>
        <!--[if IE 9.0]>
        ...
        <div id="all">
            <div class="all">
                <div id="center">
                                ...
                                <div id="header_right">
                                    <div class="header_right">
                                        <div class="header_rightin">
                                            <div class="header_fb_login">
                                                <?php
                                                $fbLink = JRoute::_('index.php?option=com_users&task=user.loginFB');
                                                ?>
                                                <a href="<?php echo $fbLink ?>">
                                                    <img src="<?php echo JURI::root()?>templates/longcms/images/facebook_login.png" />
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div id="mainmenu">
                        <div class="mainmenu">
                            <jdoc:include type="modules" name="deals_menu"/>
                        </div>
                    </div>
