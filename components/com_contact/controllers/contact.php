...
class ContactControllerContact extends JControllerForm
{
	...
	public function submit()
	{
		...
		$Itemid = JMenu::getItemid('com_contact', 'contact');
		...
		if($params->get('validate_session', 0)) {
			if(JFactory::getSession()->getState() != 'active'){
				...
				$this->setRedirect(JRoute::_('index.php?option=com_contact&view=contact&id='.$stub.'&Itemid='.$Itemid, false));
				return false;
			}
		}
		...
		if ($contact->params->get('redirect')) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_contact&view=contact&id='.$stub.'&Itemid='.$Itemid, false), $msg);
		}
