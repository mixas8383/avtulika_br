...
{
	/**
	 * Translates an internal LongCMS URL to a humanly readible URL.
	 *
	 * @param   string   $url    Absolute or Relative URI to LongCMS resource.
	...
	public static function _($url, $xhtml = true, $ssl = null)
	{
		...
		// if url is index.php, get home uri
		if ($url == 'index.php') {
			$url = 'index.php';
		} else {
