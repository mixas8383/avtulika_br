...
class JRegistry
{
	 ...
	 *
	 * @param   string  $path  Registry path (e.g. core.content.showauthor)
	 *
	 * @return  boolean
	 *
	 * @since   11.1
	...
	/**
	 * This method is added as an interim solution for API references in the LongCMS CMS 1.6 to the JRegistry
