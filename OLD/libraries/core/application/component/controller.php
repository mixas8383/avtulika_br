...
/**
 * Base class for a LongCMS Controller
 *
...
class JController extends JObject
{
	...
	{
		jimport('core.application.component.model');
	...
	public function __construct($config = array())
	{
		...
		{
			JLog::addLogger(array('text_file' => 'jcontroller.log', 'text_file_no_php'=>true), JLog::ALL, array('controller'));
		}
