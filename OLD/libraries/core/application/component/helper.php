...
class JComponentHelper
{
	...
	public static function renderComponent($option, $params = array())
	{
		...
		{
			JLog::add('Files in the format admin.COMPONENTNAME.php are considered deprecated and will not be loaded in LongCMS 3.0.', JLog::WARNING, 'deprecated');
		...
		if ($path && $app->isAdmin())
		{
			JLog::add('Files in the format toolbar.COMPONENTNAME.php are considered deprecated and will not be loaded in LongCMS 3.0.', JLog::WARNING, 'deprecated');
