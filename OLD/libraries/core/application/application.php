...
jimport('core.application.input');
jimport('core.event.dispatcher');
jimport('core.environment.response');

/**
 * Base class for a LongCMS application.
 *
...
class JApplication extends JObject
{
	...
	public function redirect($url, $msg = '', $msgType = 'message', $moved = false)
	{
		...
		else
		{
			...
			{
				// WebKit browser (identified as konqueror by LongCMS) - Do not use 303, as it causes subresources
	...
	public function login($credentials, $options = array())
	{
		...
		jimport('core.user.authentication');
	...
	public function getPathway($name = null, $options = array())
	{
		...
		jimport('core.application.pathway');
