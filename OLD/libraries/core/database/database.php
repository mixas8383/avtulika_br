...
abstract class JDatabase implements JDatabaseInterface
{
	...
	/**
	 * @var    array  The log of executed SQL statements times by the database driver.
	 * @since  11.1
	 */
	protected $logTimes = array();
	...
	/**
	 * Get the database driver SQL statement times log.
	 *
	 * @return  array  SQL statements times executed by the database driver.
	 *
	 * @since   11.1
	 */
