	...
	if ($deal->id) {
		...
		<div class="deal_imgs">
			...
			<div class="deal_socials">
				...
				<div class="socials">
					<span>
						<a target="_blank" rel="nofollow" href="http://www.facebook.com/sharer.php?u=<?php echo $deal_url; ?>&amp;title=<?php echo $deal_url; ?>" title="Facebook"  onclick="window.open(this.href,'FaceBook','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=700,height=480,directories=no,location=no'); return false;">
							<img src="templates/longcms/images/icons/facebook.png" alt="FaceBook" />
						</a>
					</span>
					<span>
						<a target="_blank" rel="nofollow" href="http://twitter.com/home?status=<?php echo $title; ?>&amp;title=<?php echo $title; ?>" title="Twitter"  onclick="window.open(this.href,'Twitter','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=700,height=480,directories=no,location=no'); return false;">
					...
					//if (JDEBUG || $_SERVER['REMOTE_ADDR'] == '94.43.206.163') {
						...
						<div class="deal_buy2" style="margin: 10px; 10px">
							<form id="deal_buy2" action="<?php echo JRoute::_('index.php?option=com_deals&task=deal.buy2'); ?>" method="post">
								 <div style="position: relative; ">
									<button type="submit"></button>
									<div style="margin-top:10px;color:red; position: absolute; right: 0px; top: -5px; width: 100px; font-weight:bold;">ყველასათვის</div>
								</div>
								<input type="hidden" name="id" value="<?php echo $id ?>" />
								<input type="hidden" name="option" value="com_deals" />
						...
						<div class="deal_buy3" style="margin: 10px; 10px">
							<form id="deal_buy3" action="<?php echo JRoute::_('index.php?option=com_deals&task=deal.buy3'); ?>" method="post">
								<div style="position: relative; ">
									<button type="submit"></button>
									<div style="margin-top:4px;color:red; position: absolute; right: 0px; top: -5px; width: 100px; font-weight:bold;">მხოლოდ რეგიონებისთვის</div>
								</div>
