 ...
 * @since		1.6
 */
class DealsModelMailjobs extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__deals_mailjobs').' AS a');
	 ...
	 * @since	1.6
	 */
	/*public function getTable($type = 'City', $prefix = 'DealsTable', $config = array())
	{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		parent::populateState('a.create_date', 'desc');
	}
}
