...
{
	/**
	 * method to preflight the update of LongCMS
	 *
	...
	protected function updateManifestCaches()
	{
		...
		$extensions[] = array('library', 'core', '', 0);
	...
	public function deleteUnexistingFiles()
	{
		$files = array(
			...
			'/libraries/core/application/applicationexception.php',
			'/libraries/core/client/http.php',
			'/libraries/core/filter/filterinput.php',
			'/libraries/core/filter/filteroutput.php',
			'/libraries/core/form/fields/templatestyle.php',
			'/libraries/core/form/fields/user.php',
			'/libraries/core/form/fields/menu.php',
			'/libraries/core/form/fields/helpsite.php',
			'/libraries/core/form/formfield.php',
			'/libraries/core/form/formrule.php',
			'/libraries/core/utilities/garbagecron.txt',
			'/libraries/phpmailer/language/phpmailer.lang-en.php',
			'/media/system/css/modal_msie.css',
			'/media/system/images/modal/closebox.gif',
			'/'.JFOLDER_ADMINISTRATOR.'/components/com_admin/sql/updates/sqlsrv/2.5.2-2012-03-05.sql',
			'/'.JFOLDER_ADMINISTRATOR.'/components/com_admin/sql/updates/sqlsrv/2.5.3-2012-03-13.sql',
			'/'.JFOLDER_ADMINISTRATOR.'/components/com_admin/sql/updates/sqlsrv/index.html',
			'/'.JFOLDER_ADMINISTRATOR.'/components/com_users/controllers/config.php',
			'/'.JFOLDER_ADMINISTRATOR.'/language/en-GB/en-GB.plg_system_finder.ini',
			'/'.JFOLDER_ADMINISTRATOR.'/language/en-GB/en-GB.plg_system_finder.sys.ini',
		...
		$folders = array(
			...
			'/'.JFOLDER_ADMINISTRATOR.'/components/com_admin/sql/updates/sqlsrv',
