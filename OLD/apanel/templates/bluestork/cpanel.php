...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo  $this->language; ?>" lang="<?php echo  $this->language; ?>" dir="<?php echo  $this->direction; ?>" >
	<head>
		...
		<![endif]-->
		<link href="<?=JURI::root()?>templates/longcms/css/src/debug.css" rel="stylesheet" type="text/css" />
	</head>
<body id="minwidth-body">
	<div id="border-top" class="h_blue">
		<span class="logo">
			<span class="cms_title">
				<a href="http://www.long.ge/?longcms">
					LongCMS
				</a>
			</span>
			<span class="cms_ver">
				Version: <?php echo $version->getShortVersion() ?>
			</span>
		</span>
