...
jimport('core.filesystem.archive');
jimport('core.filesystem.path');
jimport('core.base.adapter');

/**
 * LongCMS base installer class
 *
 * @package     	LongCMS.Platform
 * @subpackage  Installer
 * @since       11.1
...
class JInstaller extends JAdapter
{
	...
	public function discover()
	{
		...
		{
			// LongCMS 1.5 installation adapter legacy support
	...
	public function setSchemaVersion($schema, $eid)
	{
		if ($eid && $schema)
		{
			...
			if (count($schemapaths))
			{
				...
				{
					$schemapath = JPath::replaceAdmin($schemapath);
	...
	public function findManifest()
	{
		...
		if (!empty($xmlfiles))
		{
			...
			{
				// Is it a valid LongCMS installation manifest file?
	...
	/**
	 * Is the XML file a valid LongCMS installation manifest file.
	 *
