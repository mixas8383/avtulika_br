...
class JUser extends JObject
{
	...
	/**
	 * User type
	 * Used in LongCMS 1.0 and 1.5 for access control.
	 *
	 * @var    string
	 * @deprecated    12.1
	 * @see    $_authGroups
	 ...
	 * @since   11.1
	 */
	public static function getInstance($identifier = 0, $field = 'id')
	{
		// Find the user id
		if (!is_numeric($identifier))
		{
			...
			if (!$id = JUserHelper::getUserId($identifier, $field))
			{
