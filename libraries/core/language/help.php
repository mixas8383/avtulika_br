...
class JHelp
{
	...
	public static function createURL($ref, $useComponent = false, $override = null, $component = null)
	{
		...
		$search = array('{app}', // Application name (eg. 'Administrator')
			...
			'{major}', // LongCMS major version number
			'{minor}', // LongCMS minor version number
			'{maintenance}'// LongCMS maintenance version number
		);
	...
	public static function createSiteList($pathToXml, $selected = null)
	{
		...
		if (!$xml)
		{
			$option['text'] = 'English (GB) help.long.ge';
			$option['value'] = 'http://help.long.ge';
			$list[] = $option;
		}
		else
		{
