...
class JApplicationDaemon extends JApplicationCli
{
	...
	public function loadConfiguration($data)
	{
		...
		$tmp = (string) $this->config->get('author_name', 'LongCMS Platform');
		...
		$tmp = (string) $this->config->get('author_email', 'admin@long.ge');
		...
		$tmp = (string) $this->config->get('application_description', 'A generic LongCMS Platform application.');
