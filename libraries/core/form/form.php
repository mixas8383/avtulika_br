...
/**
 * Form Class for the LongCMS Platform.
 *
...
class JForm
{
	 ...
	 * the form control is set to 'longcms' however, the fields would be rendered like:
	 * <input name="longcms[foo]" /> and <input name="longcms[bar]" />.
	 *
	...
	protected function syncPaths()
	{
		...
		// multiname administrator hack
		$paths = JPath::replaceAdmin($paths);
